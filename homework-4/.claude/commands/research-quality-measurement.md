...
Rate the quality of a codebase research document by scoring each dimension below, summing the result, and assigning the quality level.
...
5. Copy the mandatory output block below into the **Verification Summary** section of the result file, filling in the values.
